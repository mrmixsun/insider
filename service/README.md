# The Insider — Service (Telegram Bot)

Сервисная версия The Insider: тот же движок (STARRI-интервью → маппинг → генерация контента), но через Telegram-бота. Каждый пользователь проходит интервью в личном чате, а данные (Business DNA, истории, артефакты) хранятся изолированно в базе.
...
# Выполни db/schema.sql в Supabase SQL Editor
